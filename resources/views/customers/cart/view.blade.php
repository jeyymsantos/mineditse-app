...
@section('content')
    <div class="container">
        ...
        <form action="/customer/cart/submit" method="POST">
            @csrf
                        ...
                        <div class="col-md-6 col-sm-12 d-flex justify-content-md-end">
                            ...
                            @if (!$carts->count() == 0)
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#proceedCartModal">
                                    Proceed
                                </button>

                                <!-- Modal -->
                                <div class="modal fade" id="proceedCartModal" tabindex="-1"
                                    aria-labelledby="proceedCartModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-scrollable">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Complete Order Details
                                                </h1>
                                            ...
                                            <div class="modal-body">
                                                <div class="col">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" id="order_method" name="order_method"
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle" style="text-align: center">
                                            ...
                                            @if ($find == 1)
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="deleteModal{{ $cart->prod_id }}"
